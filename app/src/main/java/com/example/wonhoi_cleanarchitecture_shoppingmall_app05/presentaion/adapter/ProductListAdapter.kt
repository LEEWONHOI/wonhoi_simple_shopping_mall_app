package com.example.wonhoi_cleanarchitecture_shoppingmall_app05.presentaion.adapter
...
import com.example.wonhoi_cleanarchitecture_shoppingmall_app05.databinding.ViewholderProductItemBinding
...
class ProductListAdapter : RecyclerView.Adapter<ProductListAdapter.ProductItemViewHolder>() {
    ...
    inner class ProductItemViewHolder(
        ...
        fun bindData(data: ProductEntity) = with(binding) {
            ...
            productPriceTextView.text = "${data.productPrice}円"
        }

        fun bindViews(data: ProductEntity) = with(binding) {
